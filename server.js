      ...
      try {
        ...
        const modifiedHtml = indexHtml.replace(
          ...
          `<script>
            ...
            document.getElementById("slide1").style.backgroundImage = serverData[0].movie1;
            document.getElementById("slide2").style.backgroundImage = serverData[0].movie2;
            document.getElementById("slide3").style.backgroundImage = serverData[0].movie3;
            document.getElementById("slide4").style.backgroundImage = serverData[0].movie4;
            document.getElementById("announceImg").style.backgroundImage = serverData[0].announceImg;
